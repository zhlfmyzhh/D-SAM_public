...
def parse():
    ...
    parser.add_argument('job_name', type=str,default='DG')
...
def main():
    ...
    if args.dataset_fn_keys is not None:
        for k, v in zip(args.dataset_fn_keys.split(','), args.dataset_fn_values.split(',')):                    #把多个test domain分割开来，可以不要？
            dataset_kwargs_map[k] = v                                                                           #???dictionary
